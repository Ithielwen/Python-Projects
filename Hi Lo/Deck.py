...
class Deck:
    ...
    def build(self, num_suits, num_cards):
        '''This method is used to create a deck of cards.
        
           Parameters:  
                num_suits // number of suits in a deck
                num_cards // number of cards in a suit
           Return: 
                NONE
        '''
    ...
    def shuffle(self, num_shuffles = 1):
        '''This method is used to shuffle the deck 
            ...
            Parameters:
                num_shuffles // number of times to shuffle the deck. Default 1
            Return:
                NONE
        '''
