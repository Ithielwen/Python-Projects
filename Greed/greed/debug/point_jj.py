...
class Point:
    ...
    # added boxend
    def boxend(self, end_x, end_y):
        """Takes the provided values and uses them to create a bounding box by extending the point.

        Args:
            end_x (int): amount added to x value.
            end_y (int): amount added to y value.

        Returns:
            Point: A new Point to show the limits of the bounding box.
        """
        return Point(self._x + end_x, self._y + end_y)